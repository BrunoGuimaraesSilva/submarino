        ...
        <form name="formCadastro" method="post" action="salvar/<?= $tabela ?>" data-parsley-validate="">
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="date" name="data" id="data" class="form-control" required data-parsley-required-message="Preencha a data" value="<?= $data ?>">
                </div>
                ...
                <div class="col-2">
                    ...
                    <input type="text" name="cliente_id" id="cliente_id" class="form-control" required data-parsley-required-message="Selecione o cliente" readonly value="<?= $cliente_id ?>">
                </div>
                <div class="col-10">
                    <label for="cliente">Selecione o Cliente:</label>
                    <input type="text" name="cliente" id="cliente" required data-parsley-required-message="Selecione um cliente" list="clientes" class="form-control" value="<?= $cliente ?>">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form name="formItens" id="formItens" method="post" action="itens.php" target="itens" data-parsley-validate="">
                ...
                <div class="row">
                    <div class="col-12 col-md-2">
                        <input type="text" name="produto_id" id="produto_id" class="form-control" required data-parsley-required-message="Selecione o produto" readonly <?= $disabled ?>>
                    </div>
                    <div class="col-12 col-md-4">
                        <input type="text" name="produto" id="produto" class="form-control" required data-parsley-required-message="Selecione um produto" list="listProdutos" <?= $disabled ?>>
                    ...
                    <div class="col-12 col-md-2">
                        <input type="text" name="valor" id="valor" class="form-control" required data-parsley-required-message="Preencha o valor" <?= $disabled ?>>
                    </div>
                    <div class="col-12 col-md-2">
                        <input type="number" name="quantidade" id="quantidade" class="form-control" required data-parsley-required-message="Preencha a quantidade" value="1" <?= $disabled ?>>
                    </div>
                    <div class="col-12 col-md-2">
            ...
            <iframe src="itens.php?venda_id=<?= $id ?>" width="100%" height="400px" name="itens"></iframe>
        </div>
    </div>
